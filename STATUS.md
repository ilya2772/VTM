...
|   6 | Market-data gateway и demo-feed            | готов     | 2026-07-29: 13 market tests, `pnpm check/build`, demo API/SSE smoke  | Pyth metadata/history/latest/3×WS, stale/heartbeat/reconnect; live Pyth не вызван без внешнего ключа             |
...
|   8 | UI foundation и адаптивный shell           | готов     | 2026-07-30: `pnpm check/build`, Vercel preview browser 1692/390      | Единая TradingView toolbar; компактный ticket с Long/Short рядом и расширенный Risk Coach                        |
|   9 | График и ChartProvider                     | в работе  | 2026-07-26: TradingView widget, browser 1440/390, `pnpm check/build` | Public widget встроен как reference-only; лицензируемый ChartProvider/datafeed ещё не реализован                 |
|  10 | Order ticket и подтверждение               | в работе  | 2026-07-26: DB open/close smoke, component tests, `pnpm check/build` | Market/Limit/Stop Limit, размер, плечо и подтверждение подключены к server API; SL/TP и полный preview ещё нужны |
|  11 | Панели challenge, позиций, ордеров и риска | в работе  | 2026-07-26: real DB UI smoke, browser 1440/390, `pnpm check/build`   | Состояние аккаунта, позиции, ордера, история и риск читаются с сервера; расширенные действия ещё нужны           |
|  12 | Остальные продуктовые разделы              | не начат  | —                                                                    | —                                                                                                                |
